...
@section('title', 'Editar dados do Infraclasse')

@section('content_header')
    <h1 class="m-0 text-dark">Editar Dados da Infraclasse</h1>
@stop
        ...
        <div class="col-12">
            <div class="card card-success card-outline">
                <div class="card-body">
                  ...
                  {!! Form::model($infraclasses , ['method' => 'PATCH','route' => ['infraclasses.update', $infraclasses->id]]) !!}
                  <div class="row">
